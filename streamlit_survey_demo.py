...
with survey.pages(31) as page:
    ...
    if page.current == 0:
       ...
       st.markdown("""
       Please:
       - :computer: Use <b>Chrome web browser.</b>
       - :sound: Make sure your computer <b>sound is on.</b> 
       - :headphones: <b> Use headphones </b> to ensure you hear the audio properly (please avoid laptop/phone speakers).
       - :ear: Take the study in a <b>quiet</b> environment. 
