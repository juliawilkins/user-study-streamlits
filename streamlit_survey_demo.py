...
with survey.pages(31) as page:
    ...
    if page.current == 0:
       ...
       st.markdown("""
       Please:
       <br> :computer: Use <b>Chrome web browser.</b>
       <br>  :sound: Make sure your computer <b>sound is on.</b> 
       <br> :headphones: <b> Use headphones </b> to ensure you hear the audio properly (please avoid laptop/phone speakers).
       <br> :ear: Take the study in a <b>quiet</b> environment. 
